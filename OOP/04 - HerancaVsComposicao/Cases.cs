...
{
    #region Caso 1
    //PessoaFisica é uma pessoa? sim.. herdar! 
    //Pensar tbm se  a classe que estamos herdando não receberá nenhuma alteração que deforme a relação..
    //lembra tbm que tudo que a super classe faz.. vai ser herdado por vc.. verificar se faz sentido

    //Devemos buscar o baixo Acoplamento e uma alta Coesão em nossas classes.
    //Prefira sempre o uso de Interfaces ao invés de uma Implementação.
    //Prefira sempre o uso de Composição ao invés de Herança. 

    //Preferir compposição ao invé de Herança?! ele disse que sim.. pesquisar mais
    ...
    public class TestesHerancaComposicao
    {
        ...
        {
            var pessoaHeranca = new PessoaFisica //herança
            {
                Nome = "Joao",
            ...
            var pessoaComposicao = new PessoaFisica2  //composição
            {
                Pessoa = new Pessoa //instancia pessoa e passa as infos.. agora ela possui um tipo complexo..
                {
                    Nome = "Joao",
                    DataNascimento = DateTime.Now,
                },
